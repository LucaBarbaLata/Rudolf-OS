...
class MainWindow(QMainWindow):
    def __init__(self, *args, **kwargs):
        ...
        about_action = QAction(QIcon(os.path.join('images', 'question.png')), "About Rudolf-Browser", self)
        about_action.setStatusTip("Find out more about Rudolf-Browser")  # Hungry!
    ...
    def update_title(self):
        ...
        self.setWindowTitle("%s - Rudolf-Browser" % title)
...
app.setApplicationName("Rudolf-Browser")
app.setOrganizationName("Rudolf")
